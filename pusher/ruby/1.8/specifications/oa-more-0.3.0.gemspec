...
Gem::Specification.new do |s|
  ...
  s.files = [".gemtest", ".rspec", ".yardopts", "Gemfile", "LICENSE", "README.rdoc", "Rakefile", "lib/oa-more.rb", "lib/omniauth/more.rb", "lib/omniauth/strategies/draugiem.rb", "lib/omniauth/strategies/ign.rb", "lib/omniauth/strategies/last_fm.rb", "lib/omniauth/strategies/windows_live.rb", "lib/omniauth/strategies/windows_live/windowslivelogin.rb", "lib/omniauth/strategies/yupoo.rb", "lib/omniauth/version.rb", "oa-more.gemspec", "spec/omniauth/strategies/draugiem_spec.rb", "spec/omniauth/strategies/last_fm_spec.rb", "spec/spec_helper.rb"]
  s.homepage = %q{http://github.com/intridea/omniauth}
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.6}
  s.summary = %q{Additional strategies for OmniAuth.}
  s.test_files = ["spec/omniauth/strategies/draugiem_spec.rb", "spec/omniauth/strategies/last_fm_spec.rb", "spec/spec_helper.rb"]
